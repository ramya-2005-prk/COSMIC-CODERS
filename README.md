...
## ⚠️ Safety Disclaimer
This AI is programmed to **EXPLAIN ONLY**.
- It does **NOT** approve actions.
- It does **NOT** replace human supervisors.
- Always follow official plant protocols and consult a safety officer for decisions.
